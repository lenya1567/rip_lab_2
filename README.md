...
- `http://localhost:8083/api/report?service=[название сервиса]` проверяет состояние группы сервисов (используется `Flux`)
...
Все входящие запросы на сервис А и отправленные запросы на сервис B логируются:
